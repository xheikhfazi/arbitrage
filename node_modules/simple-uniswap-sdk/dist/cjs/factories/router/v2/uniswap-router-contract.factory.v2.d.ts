...
import { IRouterMethods } from '../models/route-methods';
export declare class UniswapRouterContractFactoryV2 {
    private _ethersProvider;
    private _routerAddress;
    private _routerAbi;
    private _routerMethods;
    private _uniswapRouterContract;
    private _uniswapRouterNames;
    constructor(_ethersProvider: EthersProvider, _routerAddress?: string, _routerAbi?: JsonFragment[], _routerMethods?: Partial<IRouterMethods>);
